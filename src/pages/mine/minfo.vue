      ...
      <div class="pinfoheader">
        ...
        <div class="pinfoContent">
          ...
          <div class="headerinfos">
            <h3>{{curInfo.name?curInfo.name:curInfo.nickname}}<span
              v-show="!curInfo.sign_status && curInfo.role!=0">未签约</span></h3>
    ...
    <div class="mlists">
      ...
      <ul @click="showtip()" v-show="curInfo.role  == 1">
        <li>
          ...
          <div class="lbq"><span style="display: none">3988</span><i class="aright"><img
            src="../../assets/img/arrowRight.jpg"/> </i></div>
        </li>
        <li>
